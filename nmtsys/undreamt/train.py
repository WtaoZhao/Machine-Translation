...
def main_train():
    ...
    if args.fixed_decoder_embeddings:
        ...
        src_decoder_embeddings = device(torch.nn.Embedding(src_encoder_embeddings.weight.data.shape[0], embedding_size, 0))
        trg_decoder_embeddings = device(torch.nn.Embedding(trg_encoder_embeddings.weight.data.shape[0], embedding_size, 0))
        src_decoder_embeddings.weight.data.copy_(src_encoder_embeddings.weight.data)
        trg_decoder_embeddings.weight.data.copy_(trg_encoder_embeddings.weight.data)
