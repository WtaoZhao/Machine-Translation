...
bookname = '1'
en_dest = open('./dest/%s_cut.en' % bookname, 'r', encoding='utf-8').readlines()
zh_dest = open('./dest/%s_cut.zh' % bookname, 'r', encoding='utf-8').readlines()
align = open('./afterChamp/%s_cut.align' % bookname, 'r', encoding='utf-8').readlines()
en_out = open('./corpus/%s.corpus.en.tmp' % bookname, 'w', encoding='utf-8')
zh_out = open('./corpus/%s.corpus.zh.tmp' % bookname, 'w', encoding='utf-8')
...
en_out.close()
zh_out.close()
en_out = open('./corpus/%s.corpus.en.tmp' % bookname, 'r', encoding='utf-8').readlines()

with open('./corpus/%s.corpus.zh.tmp' % bookname, 'rb') as zh_out:
    with open('./corpus/%s.corpus.zh.utf8tmp' % bookname, "w", encoding="utf-8") as f:
        for line in zh_out:
            if not line:
                break
            else:
...
zh_out = open('./corpus/%s.corpus.zh.utf8tmp' % bookname, 'r', encoding='utf-8').readlines()
en = open('./corpus/%s.corpus.en' % bookname, 'w', encoding='utf-8')
zh = open('./corpus/%s.corpus.zh' % bookname, 'w', encoding='utf-8')
doc = open('./corpus/%s.corpus.doc' % bookname, 'w', encoding='utf-8')
...
zh.close()
doc.close()
os.remove('./corpus/%s.corpus.en.tmp' % bookname)
os.remove('./corpus/%s.corpus.zh.tmp' % bookname)
os.remove('./corpus/%s.corpus.zh.utf8tmp' % bookname)
