...
class TextDataset(ONMTDatasetBase):
	...
	def get_fields(n_src_features, n_tgt_features):
		...
		fields["src_map"] = torchtext.data.Field(use_vocab=False, #tensor_type=torch.FloatTensor,
		...
		fields["alignment"] = torchtext.data.Field(use_vocab=False, #tensor_type=torch.LongTensor,
		postprocessing=make_tgt, sequential=False)

		fields["indices"] = torchtext.data.Field(use_vocab=False, #tensor_type=torch.LongTensor,
		sequential=False)
