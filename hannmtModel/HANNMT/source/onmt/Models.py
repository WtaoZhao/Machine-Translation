...
class NMTModel(nn.Module):
	...
	"""
	def __init__(self, encoder, decoder, context, multigpu=False, context_type=""):
	...
	def forward(self, src, tgt, lengths, dec_state=None, context_index=None, part="all", cache=None, batch_i=None):
